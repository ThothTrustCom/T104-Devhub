...
public class HMACSHA {
     ...
     * @param hKey
     */
    public static short process(MessageDigest hash, byte[] hKey, short hKeyOff, short hKeyLen, byte[] msg, short mOff, short mLen, byte[] ipad, short offIPad, byte[] opad,
								short offOPad, byte[] secB, short offSecB, byte[] oMsg, short outOff) {
        if (hash.getAlgorithm() == MessageDigest.ALG_SHA_256) {
